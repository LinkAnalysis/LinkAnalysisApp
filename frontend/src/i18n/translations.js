export default {
  pl: {
    ...
    visualization: {
      ...
      settings: {
        ...
        allowDragging: "Pozwól na przeciąganie wierzchołków",
  ...
  en: {
    ...
    rowsWindow: {
      ...
      wrong_range_message: "Invalid row range",
    },
    editor: {
      nodes: "Nodes",
      edges: "Edges",
